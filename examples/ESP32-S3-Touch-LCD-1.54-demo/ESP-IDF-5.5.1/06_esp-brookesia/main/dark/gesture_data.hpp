...
constexpr Gesture::IndicatorBarData STYLESHEET_240_240_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA = {
    .main = {
        .size_min = gui::StyleSize::RECT(6, 0),
        .size_max = gui::StyleSize::RECT_H_PERCENT(6, 10),
        .radius = 5,
        .layout_pad_all = 1,
...
constexpr Gesture::IndicatorBarData STYLESHEET_240_240_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr Gesture::Data STYLESHEET_240_240_DARK_GESTURE_DATA = {
    .detect_period_ms = 20,
    .threshold = {
    ...
    .indicator_bars = {
        ...
        STYLESHEET_240_240_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA,
        [static_cast<int>(Gesture::IndicatorBarType::RIGHT)] =
        STYLESHEET_240_240_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA,
        [static_cast<int>(Gesture::IndicatorBarType::BOTTOM)] =
        STYLESHEET_240_240_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA,
    },
    .flags = {
