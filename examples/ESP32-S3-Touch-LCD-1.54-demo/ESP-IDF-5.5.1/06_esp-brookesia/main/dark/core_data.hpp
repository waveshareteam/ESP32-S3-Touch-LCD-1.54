...
constexpr uint32_t STYLESHEET_240_240_DARK_CORE_DISPLAY_BG_COLOR = 0x1A1A1A;
...
constexpr base::Display::Data STYLESHEET_240_240_DARK_CORE_DISPLAY_DATA = {
    .background = {
        .color = gui::StyleColor::COLOR(STYLESHEET_240_240_DARK_CORE_DISPLAY_BG_COLOR),
...
constexpr base::Manager::Data STYLESHEET_240_240_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 2,
    },
    .flags = {
...
constexpr const char *STYLESHEET_240_240_DARK_CORE_INFO_DATA_NAME = "Default Dark";

constexpr base::Context::Data STYLESHEET_240_240_DARK_CORE_DATA = {
    .name = STYLESHEET_240_240_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(240, 240),
    .display = STYLESHEET_240_240_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_240_240_DARK_CORE_MANAGER_DATA,
};
