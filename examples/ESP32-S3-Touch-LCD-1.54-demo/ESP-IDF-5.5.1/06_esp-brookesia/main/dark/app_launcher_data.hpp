...
constexpr AppLauncherIcon::Data STYLESHEET_240_240_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
        .size = gui::StyleSize::SQUARE(90),
        .layout_row_pad = 10,
    },
    .image = {
        .default_size = gui::StyleSize::SQUARE(60),
        .press_size = gui::StyleSize::SQUARE(45),
    },
    .label = {
...
constexpr AppLauncherData STYLESHEET_240_240_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .icon = STYLESHEET_240_240_DARK_APP_LAUNCHER_ICON_DATA,
    .flags = {
