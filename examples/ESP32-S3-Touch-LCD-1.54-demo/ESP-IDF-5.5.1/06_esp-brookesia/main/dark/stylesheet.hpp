...
constexpr Display::Data STYLESHEET_240_240_DARK_DISPLAY_DATA = {
    .status_bar = {
        .data = STYLESHEET_240_240_DARK_STATUS_BAR_DATA,
        .visual_mode = StatusBar::VisualMode::SHOW_FIXED,
    },
    .navigation_bar = {
        .data = STYLESHEET_240_240_DARK_NAVIGATION_BAR_DATA,
        .visual_mode = NavigationBar::VisualMode::HIDE,
    },
    .app_launcher = {
        .data = STYLESHEET_240_240_DARK_APP_LAUNCHER_DATA,
        .default_image = gui::StyleImage::IMAGE(&esp_brookesia_image_small_app_launcher_default_98_98),
    },
    .recents_screen = {
        .data = STYLESHEET_240_240_DARK_RECENTS_SCREEN_DATA,
...
constexpr Manager::Data STYLESHEET_240_240_DARK_MANAGER_DATA = {
    .gesture = STYLESHEET_240_240_DARK_GESTURE_DATA,
...
constexpr Stylesheet STYLESHEET_240_240_DARK = {
    .core = STYLESHEET_240_240_DARK_CORE_DATA,
    .display = STYLESHEET_240_240_DARK_DISPLAY_DATA,
    .manager = STYLESHEET_240_240_DARK_MANAGER_DATA,
};

} // namespace esp_brookesia::systems::phone

#define ESP_BROOKESIA_PHONE_DEFAULT_DARK_STYLESHEET() \
    esp_brookesia::systems::phone::STYLESHEET_240_240_DARK